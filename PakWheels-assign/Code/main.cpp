...
{
    cout << "=== Detailed Car Info ===" << endl;
    cout << "Brand  : " << c.brand << "  Model: " << c.model << endl;
    cout << "Year   : " << c.year << "  KM: " << c.kmDriven << endl;
    cout << "Price  : Rs. " << c.price << endl;
    cout << "Seller : " << c.soldBy << endl;
    cout << "Specs  : ";
    c.specs.showType();
    cout << endl;
    cout << "=========================\n"
...
{
    cout << "=== Detailed Bike Info ===" << endl;
    cout << "Brand  : " << b.brand << "  Model: " << b.model << endl;
    cout << "Year   : " << b.year << "  KM: " << b.kmDriven << endl;
    cout << "Price  : Rs. " << b.price << endl;
    cout << "Seller : " << b.soldBy << endl;
    cout << "Specs  : ";
    b.specs.showType();
    cout << endl;
    cout << "==========================\n"
...
void addSampleData()
{
    ...
    accList[accTotal++] = Accessory("Car Shiner", 50, "Cleaning", "ShineX", 50);
    accList[accTotal++] = Accessory("Seat Cover", 30, "Interior", "CoverCo", 20);
}
    ...
    do
    {
        ...
        case 10:
        {
            ...
            if (choice == 1)
            {
                cout << "\n--- Seller Profile ---\n";
                seller1.showInfo();
                cout << "Role: " << seller1.getRole() << endl;
            ...
            else if (choice == 2)
            {
                cout << "\n--- Buyer Profile ---\n";
                buyer1.showInfo();
                cout << "Role: " << buyer1.getRole() << endl;
            }
            else if (choice == 3)
            {
                cout << "\n--- Admin Profile ---\n";
                admin1.showInfo();
                cout << "Role: " << admin1.getRole() << endl;
            }
            break;
        }
        ...
        case 14:
        {
            ...
            if (carsTotal < 2)
            {
                cout << "Need at least 2 cars.\n";
                break;
            }
            cout << "Comparing: " << carList[0].getBrand() << " vs " << carList[1].getBrand() << "\n\n";

            if (carList[0] == carList[1])
                cout << "Same car model.\n";
            else
                cout << "Different cars.\n";

            if (comparePrices(carList[0], carList[1]))
                cout << carList[0].getBrand() << " is cheaper (checked via friend function).\n";
            else
                cout << carList[1].getBrand() << " is cheaper (checked via friend function).\n";

            cout << "\nDetailed view:\n";
            printCarInfo(carList[0]);
            carList[0].showDetails(true);
            break;
        }
